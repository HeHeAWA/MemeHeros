...
public class BeerBottleRenderer extends EntityRenderer<BeerBottleProjectile> {
    private final ItemRenderer itemRenderer;

    public BeerBottleRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(BeerBottleProjectile entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(BeerBottleProjectile entity) {
        return null;
    }
}