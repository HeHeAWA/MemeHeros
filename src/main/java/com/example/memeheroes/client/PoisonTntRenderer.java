...
public class PoisonTntRenderer extends EntityRenderer<PoisonTntProjectile> {
    private final BlockRenderDispatcher blockRenderer;

    public PoisonTntRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(PoisonTntProjectile entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(PoisonTntProjectile entity) {
        return null;
    }
}