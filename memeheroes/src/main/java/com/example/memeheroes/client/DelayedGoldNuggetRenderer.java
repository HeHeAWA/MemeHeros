...
public class DelayedGoldNuggetRenderer extends EntityRenderer<DelayedGoldNugget> {
    private final ItemRenderer itemRenderer;

    public DelayedGoldNuggetRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(DelayedGoldNugget entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(DelayedGoldNugget entity) {
        return null;
    }
}